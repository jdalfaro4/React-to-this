...
function Footer() {
    return (
        <footer className="fixed-bottom" style={{ height: "8vh" }}>
            <div className="d-flex justify-content-center align-items-center h-100">
                <ul className="list-unstyled">
                    <li className="d-inline-block mx-4">
                        <a href="https://www.linkedin.com/in/john-alfaro-a91b76251/" class="linkedin" className="rainbow">
                    ...
                    <li className="d-inline-block mx-4">
                        <a href="https://github.com/jdalfaro4" class="github" className="rainbow">
                    ...
                    <li className="d-inline-block mx-4">
                        <a href="https://twitter.com/JohnAlf34500728" class="twitter" className="rainbow">
